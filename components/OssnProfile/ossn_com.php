...
function ossn_profile_load_event($event, $type, $params) {
    ...
    ossn_register_menu_link('LabelMeTool', 'LabelMeTool', "http://ec2-18-221-232-171.us-east-2.compute.amazonaws.com/LabelMeAnnotationTool/tool.html?collection=LabelMe&mode=i&folder=example_folder&image=img2.jpg&username=".$owner->username, 'user_timeline');
    ossn_register_menu_link('Upload To LabelMe', 'Upload To LabelMe', 'http://ec2-107-21-69-122.compute-1.amazonaws.com/uploader.html?foldername='.$owner->username, 'user_timeline');
